...
//            });
                $http.post("/registration",$scope.part).then(function(response){
...
//        console.log($scope.part.name); 
    ...
    $scope.testServer = function(){
        console.log("you clicked sample code");
...
/*
 mongo db
 use registration
 db.registration.insert({"sample":"sample"});
 open cmd
you have to enter the public_html directory
